...
import type { TableFilterProps } from "../controlled-table/table-filter";
import type { TablePaginationProps } from "../controlled-table/table-pagination";
import cn from "utils/class-names";
import { Title } from "rizzui";
import Spinner from "../../ui/spinner";
const TableFilter = dynamic(() => import("../controlled-table/table-filter"), {
  ssr: false,
});
const TablePagination = dynamic(
  () => import("../controlled-table/table-pagination"),
  { ssr: false }
);
